 ...
 * @type {[*]}
 */
var OPTIONS_WITH_NO_ARGS = exports.OPTIONS_WITH_NO_ARGS = [].concat(_toConsumableArray(OPTION.KEEP), _toConsumableArray(OPTION.DEBUG), _toConsumableArray(OPTION.HELP), _toConsumableArray(OPTION.VERSION), _toConsumableArray(OPTION.RETURN_FILE));

/**
 * Options that an argument
 * @type {[*]}
 */
var OPTIONS_WITH_ARGS = exports.OPTIONS_WITH_ARGS = [].concat(_toConsumableArray(OPTION.PASSWORD), _toConsumableArray(OPTION.CIPHER), _toConsumableArray(OPTION.FILE_ENCODING));
