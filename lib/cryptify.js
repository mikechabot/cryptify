...
function CryptifyConfig(configArguments) {
    ...
    configArguments.forEach(function (value, index) {
        ...
        } else if (!_includes(CONST.OPTIONS.PASSWORD, configArguments[index - 1]) && !_includes(CONST.OPTIONS.CIPHER, configArguments[index - 1]) && !_this.options[configArguments[index - 1]]) {
...
CryptifyConfig.prototype.showHelp = function () {
    return this.options[CONST.OPTIONS.HELP[0]] === true || this.options[CONST.OPTIONS.HELP[1]] === true;
};

CryptifyConfig.prototype.showVersion = function () {
    return this.options[CONST.OPTIONS.VERSION[0]] === true || this.options[CONST.OPTIONS.VERSION[1]] === true;
};
